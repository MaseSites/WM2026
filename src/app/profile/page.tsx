          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-4 text-[12px] text-ink-3">
                ...
                <Link href="/team/brazil" className="flex items-center gap-1.5 hover:text-ink">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="space-y-6">
          <Section title="Favourite team" kicker="Following" icon="Shield">
            <Link href="/team/brazil" className="panel panel-hover flex items-center gap-3 p-4">
